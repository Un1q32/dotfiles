...
_G.packer_plugins = {
  ...
  ["bufferline.nvim"] = {
    loaded = true,
    path = "/home/joey/.local/share/nvim/site/pack/packer/start/bufferline.nvim",
  ...
  cmp_luasnip = {
    loaded = true,
    path = "/home/joey/.local/share/nvim/site/pack/packer/start/cmp_luasnip",
  ...
  ["friendly-snippets"] = {
    loaded = true,
    path = "/home/joey/.local/share/nvim/site/pack/packer/start/friendly-snippets",
